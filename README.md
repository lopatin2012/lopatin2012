...
**Team Lead / Senior Python-разработчик.** Воронеж. 8 лет в IT, из них 5 — в разработке на Python.

Делаю системы, которые работают на реальном производстве: цифровая маркировка
(«Честный Знак», GS1 DataMatrix), интеграция с ПЛК и ТСД, компьютерное зрение.

### Чем занимаюсь

- **Руковожу разработкой:** собрал отдел с нуля — 4 инженера (Backend, Mobile, Embedded),
  процессы код-ревью, unit- и интеграционного тестирования.
- **Отвечаю за экономику:** собственное ПО заменило дорогостоящее стороннее решение,
  расходы на поддержку линий снизились на 60%.
- **Продолжаю писать код:** Python (Django, FastAPI), Kotlin/Android, PostgreSQL,
  REST API, OpenCV.
...
- Резюме на hh.ru: https://voronezh.hh.ru/resume/331f7862ff11021d980039ed1f456e71565355
- Telegram: @HaHo4eJIoBeK
